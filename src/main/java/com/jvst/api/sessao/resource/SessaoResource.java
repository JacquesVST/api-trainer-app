...
public class SessaoResource {
	...
	public Sessao buscarSessaoPorId(@PathVariable @ApiParam(value = Doc.PARAM_ID_PREFIX + "da sessão"
		...
		return this.sessaoService.buscarSessaoPorId(idSessao);
	}
	...
	public List<Sessao> listarSessaoPorIdAula(@PathVariable @ApiParam(value = Doc.PARAM_ID_PREFIX + "de aula da sessão"
	...
	public void cadastrarSessao(@RequestBody @Valid @ApiParam(value = Doc.PARAM_ENTIDADE_PREFIX + "sessão"
			+ Doc.PARAM_ENTIDADE_SUFFIX1) SessaoForm sessaoForm) {
		this.sessaoService.cadastrarSessao(sessaoForm);
	}
}
